...
namespace MobileAPI_V2.Controllers
{
    ...
    public class EcommerceV1Controller : ControllerBase
    {
        ...
        public EcommerceV1Controller(IHostingEnvironment env, IDataRepositoryEcomm dataRepository, IConfiguration configuration, EmailTemplateService emailTemplateService)
        {
            _env = env;
